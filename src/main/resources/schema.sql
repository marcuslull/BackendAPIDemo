...
INSERT INTO full_stack_ecommerce.countries
VALUES (1, 'U.S', NOW(), NOW()),
    (2, 'UK', NOW(), NOW()),
    (3, 'Canada', NOW(), NOW());
INSERT INTO full_stack_ecommerce.divisions
...
INSERT INTO full_stack_ecommerce.customers
VALUES (
        1,
        "123 Easy St",
        default,
...
INSERT INTO full_stack_ecommerce.carts
VALUES (0, 0, 1, 'pending', default, default, default, 1);
INSERT INTO full_stack_ecommerce.vacations
VALUES (
        default,
        default,
...
INSERT INTO full_stack_ecommerce.excursions
VALUES (
        default,
        default,
        100,
...
GRANT SELECT,
    ...
    UPDATE,
    DELETE,
    EXECUTE on full_stack_ecommerce.* TO 'ecommerceapp' @'localhost';